          ...
          <div className="flex flex-col lg:flex-row">
            <div className="mr-4">
              <div className="mt-8 text-xl font-medium md:mt-0 md:mb-8 md:text-2xl">
                <Reveal children={<>Coding Journey</>} />
              </div>
              <Reveal
                children={
                  <div className="text-gray-500">
                    Since 2019, I've delved into C++, C#, and C, initially
                    creating video game mods and cheats. Recently, I've
                    transitioned to web development, exploring new avenues in
                    the field.
                  </div>
                }
              />
                ...
                <Reveal
                  children={
                    <>
                      ...
                      , and am currently pursuing further computer science
                      education online on{" "}
                      <a
